...
extern void coolLikeIncandescent( CRGB& c, uint8_t phase);
...
void drawTwinkles( CRGB* leds, size_t len)
{
...
void demo_twinklefox(uint32_t ms, CRGB* leds, uint16_t len) {
